...
**Emoji:** ${emojiString}`),
    ...
    async function editCategory(oldName: string, newName: string, newDescription: string, newEmoji: string, newEmbedDesc: string, newTicketText: string) {
      ...
      const TicketText = newTicketText || current.ticketCategories.find((c) => c.name === oldName).ticketText || 'N/A';
      const Description = newDescription || current.ticketCategories.find((c) => c.name === oldName).description;
      const EmbedDesc = newEmbedDesc || current.ticketCategories.find((c) => c.name === oldName).embedDesc;
