...
**Emoji:** ${emojiString}`),
    ...
    async function editCategory(oldName: string, newName: string, newDescription: string, newEmoji: string, newEmbedDesc: string) {
...
**Emoji:** ${Emoji}`),
    ...
    switch (interaction.options.getSubcommand(true)) {
      ...
      case 'edit': {
        ...
        editCategory(oldName, newName, newDescription, newEmoji, newEmbedDesc);
        break;
      }
      case 'delete': {
        const name = interaction.options.get('name')?.value as string;
