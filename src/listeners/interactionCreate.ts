...
To view the transcript, click [here](http://api.suta.tk/transcripts/${guildId}/${(channel as TextChannel).id}).`)
                .setTimestamp(),
            ],
          }).catch(() => {});
        }
